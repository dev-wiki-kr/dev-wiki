...
export function TopicClient({ topic }: TopicInterface) {
  return (
    <Container>
      ...
      <AccordionProvider>
        <Accordion id="1">
          <AccordionTitle>1. 개요</AccordionTitle>
          <AccordionDescription>
      ...
      <AccordionProvider>
        <Accordion id="2">
          <AccordionTitle>2. Three.js의 장점</AccordionTitle>
        </Accordion>

        <Accordion id="2.1">
          <AccordionTitle>2.1. 간편한 사용법</AccordionTitle>
          <AccordionDescription>
            Three.js는 복잡한 WebGL API를 추상화하여, 3D 그래픽을 쉽게 구현할 수 있도록 도와준다.
            이로 인해 개발자들이 저수준의 세부 사항을 깊이 이해하지 않고도 빠르게 3D 환경을 구축할
            수 있다.
          </AccordionDescription>
        </Accordion>

        <Accordion id="2.2">
          <AccordionTitle>2.2. 활발한 커뮤니티</AccordionTitle>
          <AccordionDescription>
            강력한 커뮤니티를 보유하고 있으며, 많은 개발자와 아티스트가 사용하고 있다. 커뮤니티
            내에서 다양한 튜토리얼, 도구, 플러그인, 예제 코드가 지속적으로 개발되고 공유되고 있다.
          </AccordionDescription>
        </Accordion>

        <Accordion id="2.3">
          <AccordionTitle>2.3. 플랫폼 호환성</AccordionTitle>
          <AccordionDescription>
        ...
        <Accordion id="2.4">
          <AccordionTitle>2.4. 확장성</AccordionTitle>
          <AccordionDescription>
      ...
      <AccordionProvider>
        <Accordion id="3">
          <AccordionTitle>3. Three.js의 단점</AccordionTitle>
        </Accordion>

        <Accordion id="3.1">
          <AccordionTitle>3.1. 성능 이슈</AccordionTitle>
          <AccordionDescription>
        ...
        <Accordion id="3.2">
          <AccordionTitle>3.2. 학습 곡선</AccordionTitle>
          <AccordionDescription>
        ...
        <Accordion id="3.3">
          <AccordionTitle>3.3. 문서화와 지원</AccordionTitle>
          <AccordionDescription>
        ...
        <Accordion id="3.4">
          <AccordionTitle>3.4. 브라우저 의존성</AccordionTitle>
          <AccordionDescription>
